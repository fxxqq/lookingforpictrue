...
import { NavLink, Card, CardImg, CardText, CardBody, Modal, ModalHeader, ModalBody, ModalFooter,
  CardTitle, CardSubtitle, Button , Row, Col, Container, Popover, PopoverHeader, PopoverBody} from 'reactstrap';
import TeamLead from './Pictures/TeamLead.jpg';
...
export default class Example extends React.Component {
  ...
  <Col sm={{ size :4, offset:4}}> 
    <div>
      <Card style = {{ alignSelf: 'center', height: 350, width: 350}}>
      <CardImg style = {{ alignSelf: 'center', height: 200, width: 350}} bottom width="50%" src={TeamLead} alt="Card image cap" />
        <CardBody>
    ...
    <div>
      <Card style = {{ alignSelf: 'center', height: 350, width: 350}}>
        <CardImg style = {{ alignSelf: 'center', height: 200, width: 350}} top width="50%" src={FrontendLead} alt="Card image cap" />
        <CardBody>
    ...
    <div>
      <Card style = {{ alignSelf: 'center', height: 350, width: 350}}>
        <CardImg  style = {{ alignSelf: 'center', height: 200, width: 350}} top width="50%" src={BackendLead} alt="Card image cap" />
        <CardBody>
    ...
    <Row> 
         <Col sm='3'>
    <div>
      <Card style = {{ alignSelf: 'center', height: 350, width: 254}}>
        <CardImg style = {{ alignSelf: 'center', height: 200, width: 254}} top width="50%" src={Front1} alt="Card image cap" />
        <CardBody>
    ...
    <div>
      <Card style = {{ alignSelf: 'center', height: 350, width: 254}}>
        <CardImg style = {{ alignSelf: 'center', height: 200, width: 254}} top width="50%" src={Front2} alt="Card image cap" />
        <CardBody>
    ...
    <div>
      <Card style = {{ alignSelf: 'center', height: 350, width: 254}}>
        <CardImg  style = {{ alignSelf: 'center', height: 200, width:254}} top width="50%" src={Back1} alt="Card image cap" />
        <CardBody>
          <CardTitle>U Keong Cheong (Ray)</CardTitle>
    ...
    <div>
      <Card style = {{ alignSelf: 'center', height: 350, width: 254}}>
        <CardImg style = {{ alignSelf: 'center', height: 200, width: 254}} top width="50%" src={Back2} alt="Card image cap" />
        <CardBody>
